document.addEventListener('DOMContentLoaded', function() {
    ...
    const header = `<img src=${source} alt="Logo"><nav><ul><li><a href="${link}index.html">Equipo</a></li><li><a href="${link}html/a.html">Bolsa</a></li><li><a href="${link}html/b.html">Perfil</a></li></ul></nav>`;
